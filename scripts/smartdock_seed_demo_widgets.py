#!/usr/bin/env python3
"""One-time seeding for the source-registered SmartDock demo Widgets."""
...
def seed_demo_widgets(config_path: Path, marker_path: Path) -> str:
    ...
    changed = current is None or current == []
    if changed:
        data["sidebarWidgets"] = list(DEMO_WIDGET_IDS)
    ...
    marker_path.write_text("fdm-977 demo widgets seeded v1\n", encoding="utf-8")
