...
demo_widget_seed_marker="$config_dir/.demo-widgets-seeded-v1"
...
case "$demo_widget_seed_result" in
  seeded) echo "Enabled SmartDock demo Widgets for this installation." ;;
  preserved) echo "Preserved existing Widget selection." ;;
  already) ;;
