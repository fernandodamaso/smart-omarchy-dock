...
| 2. Lifecycle/placement | PASS_WITH_ATTRIBUTION | task8c QEMU PID 1922406 / address 0x5559cc5246d0 established silently on ws 4; exact host window remained inactive and host focus/workspace stayed unchanged. Host cursor deltas were correlated to passive Razer event9 X/Y input; guest did not move or focus the host. ~/.local/state/smartdock/dev-sessions/task8c/evidence/pointer-focus-gate-task8c-final.json |
