...
export function interactionFixture() {
  ...
  const controller = qmlMethods('DockSidebarController.qml', { DockModel,WindowModel,SidebarModel,
    InteractionModel,
    DesktopModel:loadModel('DockDesktopModel'),Qt:{callLater(){}, NoModifier:0},host:{windowActions:actions},
    ...
    herdrFocusErrors:{}, latestFocusRequestId:'', pendingFocusByRequest:{}, pendingFocusByAgent:{},
    herdrAssociations:{byWindowKey:{}, unmatchedServerIds:[]},
