...
const icons = model('DockIconModel')
...
assert.deepEqual(plain(DockModel.mergeSettings({ iconOverrides: original }, DockModel.resetSettingsPatch()).iconOverrides), original)

// Execute actual host methods, substituting only writer and session services.
const writes = []
const host = vm.createContext({
  DockIconModel: icons, DockModel,
