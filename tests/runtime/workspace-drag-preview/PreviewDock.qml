...
Item {
  ...
  readonly property var iconOverrides: ({
    "preview.chrome": Qt.resolvedUrl("assets/lucide/rocket.svg"),
    "preview.files": Qt.resolvedUrl("assets/lucide/folder-open.svg"),
    "preview.terminal": Qt.resolvedUrl("assets/lucide/terminal.svg"),
    "preview.chat": Qt.resolvedUrl("assets/lucide/sparkles.svg"),
    "preview.notes": Qt.resolvedUrl("assets/lucide/layout-grid.svg"),
    "preview.code": Qt.resolvedUrl("assets/lucide/settings-2.svg"),
    "preview.mail": Qt.resolvedUrl("assets/services/gmail.svg")
  })
